...
public class Level2Manager : SpawnerManager {
	...
	public override void _Ready() {
		...
		AddPhase(new List<string>(){"IceFairy-02-00", "IceFairy-02-01", "FireFairy-02-02"});	// heal
		...
		AddPhase(new List<string>(){"VertexFairy-07-00", "VertexFairy-07-01", "ShotgunFairy-07-02"});	// heal
