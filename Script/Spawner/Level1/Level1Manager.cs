...
public class Level1Manager : SpawnerManager {
	...
	public override void _Ready() {
		...
		AddPhase(new List<string>(){"WindFairy-02-00", "WindFairy-02-01", "LightFairy-02-02"});
		...
		AddPhase(new List<string>(){"VertexFairy-05-00", "VertexFairy-05-01"});
		AddPhase(new List<string>(){"FireFairy-06-00", "IceFairy-06-01"});
